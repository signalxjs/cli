...
[GitHub Discussions](https://github.com/signalxjs/cli/discussions). It keeps
...
- [Report a bug](https://github.com/signalxjs/cli/issues/new?template=bug_report.yml)
- [Request a feature](https://github.com/signalxjs/cli/issues/new?template=feature_request.yml)

Before filing, please:

- Check existing [issues](https://github.com/signalxjs/cli/issues?q=is%3Aissue) and
  [discussions](https://github.com/signalxjs/cli/discussions) to avoid duplicates.
